...
function greeter(hour) {
    ...
    // make a if else if series, that starts with the lowest possible range using equal to or less than of the ranges max,
    //and if it its less than and not exceeding that range, console log. but otherwise, move to next range, which has a higher max.
    //continue on, and end at 24.
    // hour is 0-11
 if (hour <=11) {
